...
export default function page() {
    ...
    return <LayoutCourseCustom>
        ...
        <PCourse className={"simple-my"}>Le <SpanCourse>navigateur</SpanCourse> est le <SpanCourse>client</SpanCourse>.</PCourse>
        ...
        <PCourse className={"simple-mt"}>Les <SpanCourse>requêtes</SpanCourse> et les <SpanCourse>réponses</SpanCourse> contiennent des <SpanCourse>headers</SpanCourse>.</PCourse>
        ...
        <PCourse className={"simple-mt mb-3"}>Voici quelques exemples de <SpanCourse>méthodes HTTP</SpanCourse> :</PCourse>
        ...
        <PCourse className={"simple-mt"}>Les méthodes <SpanCourse>GET</SpanCourse>, <SpanCourse>POST</SpanCourse>, <SpanCourse>PATCH</SpanCourse> et <SpanCourse>DELETE</SpanCourse> sont les plus utilisées.</PCourse>
        ...
        <PCourse className={"simple-mt mb-3"}>Voici quelques exemples de codes de statut HTTP :</PCourse>
        <UlCourse>
        ...
        <PCourse className={"simple-mt mb-3"}>Une URL est composée de plusieurs parties :</PCourse>
        <UlCourse>
            ...
            <LICourse><SpanCourse>Requête</SpanCourse> ou <SpanCourse>SearchParams</SpanCourse> : ?id=1&name=John (paires de clés/valeurs venant après le <SpanCourse>?</SpanCourse> et séparés par <SpanCourse>&</SpanCourse>)</LICourse>

            <LICourse><SpanCourse>Ancre</SpanCourse> : #section1, #section2, etc.</LICourse>
        </UlCourse>

        <Link href="/http/url-details.jpg" target="_blank" className={"simple-mt block"}>
            <Image className={"rounded-3xl shadow-md"} src={imgUrlDetails} alt="URL détails" />
        </Link>
        ...
        <PCourse className={"simple-mt mb-3"}>Voici quelques exemples de ce que peut contenir un header :</PCourse>
        ...
        <PCourse className={'simple-my'}>Le corps de la requête est utilisé dans les méthodes <SpanCourse>POST</SpanCourse>, <SpanCourse>PUT</SpanCourse> et <SpanCourse>PATCH</SpanCourse>.</PCourse>
        ...
        <PCourse className={"simple-mt"}>Le <SpanCourse>corps de la réponse</SpanCourse> ou <SpanCourse>BODY</SpanCourse> est l&apos;endroit où le serveur envoie des données au client.</PCourse>
        ...
        <PCourse className={"simple-mt mb-3"}>Les cookies :</PCourse>
        <UlCourse>
        ...
        <PCourse className={"simple-mt"}>Il est plus facile pour un humain de retenir une adresse web (URL) qu&apos;une adresse IP.</PCourse>
