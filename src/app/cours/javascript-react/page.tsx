...
const javascriptReactCourses: Course[] = [
    {
        title: "Javascript - Introduction",
        description: "Découvrir les mécanismes de base du javascript",
        image: gitImage,
        duration: 5,
        href: "/cours/javascript-react/introduction"
    },
    {
        ...
        image: vsCodeImage,
        duration: 2,
        href: "/cours/javascript-react/fonctionnement"
    },
    {
        ...
        image: vsCodeImage,
        duration: 2,
        href: "/cours/javascript-react/hooks"
    }
]
export default function Page() {
    ...
    return <Main>
        ...
        <div className="flex gap-32 mt-12 justify-center flex-wrap">
            ...
            {javascriptReactCourses.map(course => (
