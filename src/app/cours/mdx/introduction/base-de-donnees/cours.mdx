...
<p>Il faudra de plus ouvrir un serveur afin d'éffectuer nos requêtes SQL pour cela un outil très utilisé est <a href={""} target={"_blank"}>WAMP ou ses variants suivant le système d'éxploitation (Windows, Mac, Linux...)</a>.</p>
...
<a href="/MCD.jpg" target="_blank"><img src="/MCD.jpg" alt="MCD, MLD et MPD" /></a>


<p>Vue d'une table, ses champs (colonnes) et enregistrements (lignes).</p>
<a href="/exemple-database.jpg" target="_blank"><img src="/exemple-database.jpg" alt="exemple base de données" /></a>
